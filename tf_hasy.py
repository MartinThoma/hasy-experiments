...
import input_data
from utils import write_analyzation_results, pretty_print

batch_size = 128
epochs = 100000  # 200000
MODEL_NAME = 'tf-cnn'
model_checkpoint_path = 'hasy_%s_model.ckpt' % MODEL_NAME
...
for fold in range(1, 11):
    ...
    with tf.Session() as sess:
        ...
        validation_curve_path = ('validation-curve-accuracy-%s.csv' %
                                 MODEL_NAME)
